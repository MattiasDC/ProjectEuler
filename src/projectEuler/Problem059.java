	...
	protected String solve() {
		...
		try {
			...
			for (String cipher : line.split(",")){
				...
				else parsedCipher += value;
			}
		} catch (IOException e) {
		}


		System.out.println("This problem can be solved by running the self made XOR program. The cipher u should use is:");
		System.out.println(parsedCipher);
		
		String text = JOptionPane.showInputDialog("Paste the ASCII values of the original text in here");
		int answer = 0;
